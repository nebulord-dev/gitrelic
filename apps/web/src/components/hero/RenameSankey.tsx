...
export function RenameSankey({ report, selectedFile, onSelectFile }: RenameSankeyProps) {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-full">
      ...
      {tooltip && (
        <div
          className="absolute bg-tooltip-bg border border-border-primary rounded px-2.5 py-[6px] text-[10px] text-tooltip-text pointer-events-none z-20 max-w-[320px] break-all"
